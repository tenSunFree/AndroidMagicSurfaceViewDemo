package com.example.administrator.androidmagicsurfaceviewdemo;
...
import com.example.administrator.androidmagicsurfaceviewdemo.common.FloatValueAnimator;
import com.example.administrator.androidmagicsurfaceviewdemo.common.MagicActivity;
import com.example.administrator.androidmagicsurfaceviewdemo.launch.LaunchBackgroundUpdater;
import com.example.administrator.androidmagicsurfaceviewdemo.launch.LaunchButtonMatrixUpdater;
import com.example.administrator.androidmagicsurfaceviewdemo.launch.LaunchButtonModelUpdater;
import com.example.administrator.androidmagicsurfaceviewdemo.launch.LaunchSceneUpdater;
import com.example.administrator.androidmagicsurfaceviewdemo.launch.LaunchTextModelUpdater;
...
public class LaunchActivity extends MagicActivity {
    ...
    private PointLight mLight = new PointLight(0XFFea0000, 0, 0, 0.1f);
            ...
            if (++endAnimatorCount == 5) { // 所有动画结束后调用
                ...
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        ...
                        finish();
                        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);     // 系统自带的淡入淡出的效果
                    }
                }, 2000);
            }
        }
    ...
    private void initViews() {
        ...
        mBtnEnter = (ImageView) findViewById(R.id.btn_enter);
